...
int main(int argc, const char * argv[]) {
    ...
    ofstream filemc;
    filemc.open("LJ_T09_dmax1.txt",ios::out);
    filemc.precision(10);

    ofstream filemc3;
    filemc3.open("LJ_a_T09_dmax1.txt",ios::out);
    filemc3.precision(10);

    ofstream filemc4;
    filemc4.open("LJ_E_T09_dmax1.txt",ios::out);
    filemc4.precision(10);

    ofstream filemc5;
    filemc5.open("LJ_P_T09_dmax1.txt",ios::out);
